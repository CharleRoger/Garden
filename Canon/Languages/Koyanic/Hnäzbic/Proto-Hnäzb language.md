...
It is estimated that Proto-Hnäzb was spoken by the [[Northern-Koty Pre-Metallic Complex]] and by the [[South-Koyanic Pastoralic Complex]]. The former likely spoke an early form of Proto-Hnäzb, still more in line with its ancestral language, while the latter made up the speaker community of the ancestral language of all Hnäzb languages. For this reason the [[South-Koyanic Pastoralic Complex|SKP]] is sometimes called the Proto-Hnäzb culture.
...
# Development from Proto-Koyanic
...
Spirantisation of voiceless approximants:
...
- (t)ɬ (t)s p t k q > tɬʼ tsʼ pʼ tʼ kʼ qʼ / \_{x₁, x₂, x₃}
...
| ---------- | --------- | --- | -------- | -------- | --------- | --------- | --------- | -------- | -------- | ------- |
| Plosive    | Plain     | -   | **\*p**  | **\*t**  | **\*tɬ**  | **\*ts**  | **\*tɕ**  | **\*k**  | **\*q**  | **\*ʔ** |
| ^          | Aspirated | -   | **\*pʰ** | **\*tʰ** | **\*tɬʰ** | **\*tsʰ** | **\*tɕʰ** | **\*kʰ** | **\*qʰ** |         |
| ^          | Ejective  | -   | **\*p'** | **\*t'** | **\*tɬ'** | **\*ts'** | **\*tɕ'** | **\*k'** | **\*q'** |         |
| Continuant | Unvoiced  | -   | **\*m̥** | **\*n̥** | **\*ɬ**   | **\*s**   | **\*ɕ**   | **\*x**  | **\*χ**  | **\*h** |
| ^          | Voiced    | -   | **\*m**  | **\*n**  | **\*l**   | **\*z**   | **\*j**   | **\*ɰ**  | **\*ʁ**  |         |
...
- All affricates become \*t before another affricate or \*t.
...
The categories of high-animate and low-animate descend from the [[Proto-Koyanic language|Proto-Koyanic]] categories of animate singular and animate plural respectively. In some Hnäzbic languages, they are similar to a distinction between humans and non-humans, however generally they don't map to these concepts precisely and low-animate is also used for groups of humans or generic terms like *man* or *woman* and similar terms (false plurals and collectives).

The low-animate class can also be used derogatorily to insult people by likening them to animals. At the same time, some instances of its use are to be understood as neutral and are just artefacts of its origin as an animate plural. Conversely, the high-animate is also used on particular animals seen as noble creatures or mythical beings.

| Class        | Nouns                                                                                                                       | Origin           |
| ------------ | --------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| High-animate | Humans (including personal names), deities and spirits, peoples and professions, some domestic animals ([[Ugo]] and cattle) | Animate singular |
...
There eight cases in total: **absolutive**, **accusative**, **partitive**, **ergative**, **genitive**, **instrumental**, **dative** and **locative.** Each case is marked with a suffix in a declension paradigm determined by the class of the noun.

#### Case suffixes

|              | -   | High-animate                                 | Low-animate                             | Inanimate                                  |
| ------------ | --- | -------------------------------------------- | --------------------------------------- | ------------------------------------------ |
| Absolutive   | -   | \*-('/ɰ)a                                    | \*-∅,<br>\*-('/ɰ)a                      | \*-('/ɰ)āχ                                 |
| Accusative   | -   | \*-ē                                         | \*-e (singular),<br>\*-('/ɰ)a (plural)  | \*-∅ (singular?),<br>\*-('/ɰ)āχ (plural?)  |
| Partitive    | -   | \*-('/ɰ)a                                    | \*-ʁan                                  | \*-ʁan,<br>\*-('/ɰ)āχ                      |
| Ergative     | -   | \*-ɨ̄ɰāχ                                     | \*-ātt'ɨ                                | \*-ɨ̄yɨ̄ɬ                                  |
| Genitive     | -   | \*-nɨts'āχ (possessive),<br>\*-māχ (generic) | \*-nɨs (possessive),<br>\*-mɨ (generic) | \*-mɨ̄nk                                   |
...
The ventive is formed with the prefix **\*o-** or a labial-grade vocalic change. The prefix can also cause labialisation or labial-affection. 
...
The separative is formed with the prefix **\*a-**, or a vocalic grade of the stem. In most cases this vocalic great is unchanging, yet in some daughter languages it causes dialabialisation through analogy. 
...
The habitual is formed through the prefix **\*ōN-** with an indistinct nasal ending, which might nasalise the following onset or in turn adapt to the following consonant. Reduction is also possible though less likely through the long vowel.

The habitual prefix is less prone to loss and can cause labial affection on the stem vowel in daughter languages.

#### Frequentative

The frequentative is the the converged plural form of the former progressive infixes. The frequently is an unstable form. It gave rise to either a frequentative aspect (doing something repeatedly) or an aspectual form either terminative (having done already) or prospective (will be doing again) or forms of verbal plurality. The frequently is not very stable and can also merge with the habitual or take its place if a chain shift occurs. 

#### Examples

(If there is no cluster and just a continuant and the vowel is either \*a or \*o it might be reanalysed as part of the prefix)

| Root    | Ventive stem                                    | Separative stem                              |
| ------- | ----------------------------------------------- | -------------------------------------------- |
| \*ʔotsʼ | \*ʔotsʼ "to cook for oneself/to cook something" | \*ʔatsʼ "to cook for someone"                |
| \*kne   | \*okne "to cry"                                 | \*akne "to lament"                           |
| \*semt  | \*osemt "to die"                                | \*asemt "to be killed"                       |
| \*klat  | \*oklat "to be happy"                           | \*aklat "to enjoy something"                 |
| \*χō    | \*χō "to listen"                                | \*χā "to perceive audible"                   |
| \*zai   | \*zoi "to watch"                                | \*zai "to perceive visually"                 |
| \*tau   | \*otau "to speak (to someone)"                  | \*atau "to speak in favour of someone/thing" |
| \*nāq   | \*onāq "to come"                                | \*anāq "to go away"                          |
| \*sm̥ōm | \*osm̥ōm "to relieve oneself"                   | \*asm̥ōm "to piss"                           |
...
| -------- | -------- | --- | -------- | ------------------ | ------------------- | ---------------- | ------------------ | ------------------- |
| Non-Past | Positive | -   | \*mi(n)- | \*simɨ- \~ \*simy- | \*sumɨ- \~ \*sumy-  | \*ūmɨ- \~ \*ūmy- | \*somɨ- \~ \*somy- | \*zomɨ- \~ \*zomy-  |
| ^        | Negative | -   | \*om-    | \*onu- \~ \*onw-   | \*onɨ- \~ \*ony-    | omɨr-            | onur-              | onɨr-               |
| Past     | Positive | -   | \*tʰok-  | \*pʰok-            | \*-∅,<br>\*kʰə̄(ʔ)- | \*tʰor-          | \*pʰor-            | \*-∅,<br>\*kʰə̄ʔər- |
| ^        | Negative | -   | \*tʰom-  | \*pʰom-            | \*-∅, \*kʰə̄m-      | tʰomər-          | pʰomər-            | \*-∅, \*kʰə̄mər-    |
...
- \*onw-asm̥ōm "You are not peeing"
- \*kʰə̄-χā "They (sg) heard something" / "It was heard"
- \*omē tʰokʰ-otau "I spoke to a baby"
- \*oma tʰokʰ-otau "I spoke to babies"
- \*omē tɨ-tʰokʰ-otau "I spoke to the baby"
- \*omtsəmē tɨ-tʰokʰ-otau "I spoke to the babies"
